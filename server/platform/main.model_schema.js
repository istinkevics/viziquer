...
Schemas.Projects = new SimpleSchema({
	...
	// TODO: MySQL stuff goes below, should it be separated?
	dbHostname: {
		type: String,
		label: 'Projects.dbHostname',
		optional: true,
	},

	dbPort: {
		type: String,
		label: 'Projects.dbPort',
		optional: true,
	},

	dbUsername: {
		type: String,
		label: 'Projects.dbUsername',
		optional: true,
	},

	dbPassword: {
		type: String,
		label: 'Projects.dbPassword',
		optional: true,
	},

	dbName: {
		type: String,
		label: 'Projects.dbName',
		optional: true,
	},
